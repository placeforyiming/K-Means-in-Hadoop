...
public class Combiner_K_means {
    ...
    public static class Tools{
        ...
        public static boolean Compare(String centerPath,String newPath) throws IOException{
            ...
            input_new.close();
            input_old.close();
            if ((Distance_total-Combiner_K_means.Threshold)>0){
    ...
    public static void run(String centerPath,String dataPath,String newCenterPath,boolean runReduce) throws IOException, ClassNotFoundException, InterruptedException{
         ...
         job.setJarByClass(Combiner_K_means.class);
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
         ...
         Combiner_K_means.Round = Integer.parseInt(args[3]);
         Combiner_K_means.Threshold=Double.parseDouble(args[4]);
         ...
         while(true){
             ...
             if(Tools.Compare(centerPath,newCenterPath) || (count== Combiner_K_means.Round)){
